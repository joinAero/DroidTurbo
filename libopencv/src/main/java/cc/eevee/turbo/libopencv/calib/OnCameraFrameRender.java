...
class ComparisonFrameRender extends FrameRender {
    ...
    public Mat render(CvCameraViewFrame inputFrame) {
        ...
        Imgproc.putText(comparisonFrame, mResources.getString(R.string.ocv_original), new Point(mWidth * 0.1, mHeight * 0.1),
                Core.FONT_HERSHEY_SIMPLEX, 1.0, new Scalar(255, 255, 0));
        Imgproc.putText(comparisonFrame, mResources.getString(R.string.ocv_undistorted), new Point(mWidth * 0.6, mHeight * 0.1),
                Core.FONT_HERSHEY_SIMPLEX, 1.0, new Scalar(255, 255, 0));
