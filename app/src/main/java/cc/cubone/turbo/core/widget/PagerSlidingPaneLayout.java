package cc.cubone.turbo.core.widget;
 ...
 *
 * @see <a href="http://stackoverflow.com/questions/17490899/using-androids-slidingpanelayout-with-viewpager">
 *     Using Android's SlidingPaneLayout with ViewPager</a>
 */
public class PagerSlidingPaneLayout extends SlidingPaneLayout {
    ...
    public PagerSlidingPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
